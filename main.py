...
Generate approximately {options['target_count']} test cases with proper distribution.
...
def main():
    ...
    with st.sidebar:
        ...
        target_count = st.number_input(
            ...
            value=100,
            step=10,
            help="Approximate number of test cases to generate"
        )
